...
import { Upload as UploadIcon, Plus, ShieldCheck, Zap, ArrowRight, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-full bg-background grid-pattern p-8 lg:p-16 overflow-y-auto">
      ...
      <div className="max-w-6xl mx-auto mb-16 flex flex-col md:flex-row justify-between items-end gap-10">
        <div className="max-w-2xl">
          <Badge variant="primary" className="mb-6">v4.0 Core Engine</Badge>
          <Heading level={1} className="mb-6">Contract Intake</Heading>
          <Text>
            Upload your legal documents for comprehensive AI-driven analysis. Our preprocessing layer identifies risk profiles and redacts sensitive data with architectural precision.
          </Text>
        </div>
        <div className="hidden lg:block text-right">
          <Text variant="label" className="mb-1">Current Workspace</Text>
          <div className="text-2xl font-black text-primary tracking-tighter">Pre-processing Node 01</div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        >
          <Card padding="p-2" className="h-full bg-surface-container-high/50 border-2 border-primary/5">
            <div className="bg-white h-full rounded-[2rem] p-16 flex flex-col items-center justify-center border-2 border-dashed border-surface-container-high group-hover:border-primary/40 transition-all cursor-pointer shadow-inner">
              ...
              <Heading level={2} className="mb-4">Drop Contract Here</Heading>
              ...
              <div className="mt-20 flex gap-8 w-full">
                <FeatureSmall icon={<ShieldCheck size={24} />} label="Security" value="End-to-End Encryption" />
                <FeatureSmall icon={<Zap size={24} />} label="Speed" value="Instant Pre-scan Active" />
              </div>
            </div>
          </Card>
        </motion.div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-10">
          ...
          >
            <Card hover={false} className="bg-white/80 backdrop-blur-xl border-primary/10 shadow-xl shadow-primary/5">
              <Text variant="label" className="border-b border-surface-container-high pb-6 mb-8 block">
              ...
              <div className="pt-8 mt-8 border-t border-surface-container-high">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-black text-on-surface uppercase tracking-widest">Privacy Redaction</span>
                ...
                <Text variant="detail" className="leading-relaxed">
                  Automatically redact names, addresses, and financial values before AI processing for maximum confidentiality.
                </Text>
              </div>
            </Card>
          </motion.div>
          ...
          >
            <Card padding="p-6" className="bg-linear-to-br from-primary/10 to-transparent border-primary/20 shadow-none overflow-hidden relative">
              ...
              <div className="flex gap-6 relative z-10">
                ...
                <div>
                  <Text variant="label" className="text-primary mb-2">AI Recommendation</Text>
                  <Text variant="detail" className="text-primary/80 leading-relaxed font-bold">
                    Based on current legal trends, we recommend enabling "Clause Comparison" for multi-jurisdictional compliance checks.
                  </Text>
                </div>
              </div>
            </Card>
